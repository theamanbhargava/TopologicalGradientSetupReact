...
export const setup = () => {
    ...
    console.log(document.querySelector('svg.scene'))
    //TODO: temporary
    ...
    const open = (pos) => {
        ...
        currentBlob.expand().then(() => {
            ...
            anime({
                targets: [contentInner.querySelectorAll('.content__title > span'), contentInner.querySelectorAll('.content__subtitle > span')],
                duration: 200,
